    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < noOfFiles; i++) {
            ...
            try {
                ...
                System.out.println("Actual string :" + readString[i]);
                System.out.println("From Binary: " + toActualString(toBinaryString(readString[i])));
                System.out.println("bEFORE SPREAD : " + toBinaryString(readString[i]));
        ...
        StringBuilder toBeSent = combineSignals(finalString[0], finalString[1], finalString[2]);
        
        System.out.println("Out " + toBeSent);
        out.writeUTF(toBeSent.toString());
        out.flush();
